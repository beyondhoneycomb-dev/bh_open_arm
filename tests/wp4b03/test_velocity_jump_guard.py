...
def test_velocity_limit_clamps_to_motor_vmax() -> None:
    ...
    # J1/J2 DM8009 45, J3/J4 DM4340 8, J5-J7+gripper DM4310 30 (FR-INF-039).
    assert resolved == (45.0, 45.0, 8.0, 8.0, 30.0, 30.0, 30.0, 30.0)
...
def test_motor_vmax_read_from_table() -> None:
    ...
    assert motor_vmax_rad_s(MotorType.DM8009) == 45.0
    assert motor_vmax_rad_s(MotorType.DM4340) == 8.0
    assert motor_vmax_rad_s(MotorType.DM4310) == 30.0
