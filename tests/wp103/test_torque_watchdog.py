...
The distinction this file has to keep visible: **tau to zero is not torque off.** Cutting
torque on this arm is a fall (`04` 수동-동작 §2: 기계식 브레이크는 없다). The watchdog's
degradation is a powered hold — the position command becomes the present pose and the
feed-forward term becomes zero, while the hold gains keep standing.
