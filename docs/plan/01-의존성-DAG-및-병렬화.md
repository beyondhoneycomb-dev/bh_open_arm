...
| `CTR-ERR@v1` | **`OA-*` 에러코드 레지스트리** | **`WP-OPS-06`** (B-6) | 🔴 **0-Ops 퇴장**(생산자 `WP-OPS-06`이 0-Ops 내부라 대역 진입 전 동결 불가 — 0-Ops 내부에서 `WP-OPS-06` → 소비자 순차, Wave 1 이전 완료) | **전부** | `14` §2.10 · `FR-OPS-020` |
